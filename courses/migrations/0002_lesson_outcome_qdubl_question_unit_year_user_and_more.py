    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p', models.CharField(default='1', max_length=400)),
                ('s', models.CharField(default='1', max_length=400)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('k', models.CharField(default='1', max_length=400)),
                ('q', models.CharField(default='1', max_length=400)),
                ('p', models.CharField(default='1', max_length=400)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('q', models.CharField(default='1', max_length=400)),
                ('p', models.CharField(default='1', max_length=400)),
                ('l', models.CharField(default='1', max_length=400)),
                ('u', models.CharField(default='1', max_length=400)),
                ('s', models.CharField(default='1', max_length=400)),
                ('name', models.TextField(null=True)),
                ('op1', models.CharField(max_length=200, null=True)),
                ('op2', models.CharField(max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p', models.CharField(default='1', max_length=400)),
                ('name', models.CharField(max_length=400)),
                ('users', models.ManyToManyField(related_name='subjects', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SubjectEval',
